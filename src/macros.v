...
Definition ASSERT_NONE {a S} : instruction (option_ a ::: S) S :=
  IF_NONE NOOP FAIL.

Definition ASSERT_SOME {a S} : instruction (option_ a ::: S) (a ::: S) :=
  IF_NONE FAIL NOOP.
...
Definition IF_SOME {a SA SB} bt bf : instruction (option_ a ::: SA) SB :=
  IF_NONE bf bt.
